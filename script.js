...
// script.js - handles particles, GSAP animations, typed, modals, lightbox, resume download, magnetic buttons, dark mode

// Load tsParticles JSON (fetch local file)
(async ()=>{
  try{
...
// Theme: use data-theme attribute on <html> or <body>
...
function updateThemeButton(){
  if(root.getAttribute('data-theme') === 'dark') themeToggle.textContent = '☀️'; else themeToggle.textContent = '🌙';
}
updateThemeButton();
